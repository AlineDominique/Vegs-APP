 ...
 */
public class ActAtualizaReceita extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_atualiza_receita);
        ...
        try {
            ...
            Toast.makeText(ActAtualizaReceita.this, "Não foi possível completar a operação!", Toast.LENGTH_SHORT).show();
        }

        //Constrói mensagem de diálogo.
        dialogo = new AlertDialog.Builder(ActAtualizaReceita.this);
        ...
        dialogo.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                startInstalledAppDetailsActivity(ActAtualizaReceita.this);
            }
        });
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.menuAjuda:
                ...
                return true;
            case R.id.menuSobre:
                Intent intent1 = new Intent(ActAtualizaReceita.this, ActSobre.class);
            ...
            case R.id.menuSair:
                ...
                //Chama tela de login
                Intent principal = new Intent(ActAtualizaReceita.this, ActLogin.class);
    ...
    public void setaCalendario() {
        ...
        etTempoPreparo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final TimePickerDialog mTimePicker = new TimePickerDialog(ActAtualizaReceita.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
                ...
                TextView tvTitle = new TextView(ActAtualizaReceita.this);
    ...
    public void recuperaDadosReceita(){

        //Carrega a foto da receita selecionada.
        ivFoto = (ImageView) findViewById(R.id.ivFoto);
        Picasso.with(getBaseContext()).load(receita.getFoto()).transform(new TransformacaoCirculo()).into(ivFoto);

        //Carrega nome da Receita
        etNome = (EditText) findViewById(R.id.etNome);
        etNome.setText(receita.getNome());

        //Carrega tempo de preparo da receita.
        etTempoPreparo = (EditText) findViewById(R.id.etTempoPreparo);
        etTempoPreparo.setText(receita.getTempoPreparo());

        //Carrega modo de preparo da receita.
        etModoPreparo = (EditText) findViewById(R.id.etModoPreparo);
        etModoPreparo.setText(receita.getModoPreparo());

        //Carrega dicas da receita.
        etDicas = (EditText) findViewById(R.id.etDicas);
        etDicas.setText(receita.getDicas());
    ...
    public void CarregaSpinners(){
        ...
        pd = ProgressDialog.show(ActAtualizaReceita.this, "", "Por favor, aguarde...", false);
        processos++;
        try {
            new ActAtualizaReceita.RequisicaoAsyncTask().execute("ListarCategorias", "0", "");
        }catch(Exception ex){
            Log.e("Erro", ex.getMessage());
            Toast.makeText(ActAtualizaReceita.this, "Não foi possível completar a operação!", Toast.LENGTH_SHORT).show();
        }
        ...
        String elemento = receita.getPorcoes();
        int index = -1;
        for (int i=0;i<porcoes.length;i++) {
            if (porcoes[i].equals(elemento)) {
                index = i;
                break;
            }
        }

        spPorcoes.setSelection(index);
    ...
    public void CadastraReceita() {
        ...
        try {
            ...
            if (erro.equals("")) {
                ...
                json.put("Foto", Imagem.fotoEncode(Imagem.recuperaCaminho(imagemSelecionada, ActAtualizaReceita.this)));
                ...
                pd = ProgressDialog.show(ActAtualizaReceita.this, "", "Por favor, aguarde...", false);
                processos++;
                new ActAtualizaReceita.RequisicaoAsyncTask().execute("AtualizarReceita", String.valueOf(receita.getIdReceita()), json.toString());

            } else {
                Toast.makeText(ActAtualizaReceita.this, erro, Toast.LENGTH_LONG).show();
            }
        }catch (Exception ex){
            Log.e("Erro", ex.getMessage());
            Toast.makeText(ActAtualizaReceita.this, "Não foi possível completar a operação!", Toast.LENGTH_SHORT).show();
    ...
    public void verificaPermissao(){
        if(ContextCompat.checkSelfPermission(ActAtualizaReceita.this,
                android.Manifest.permission.READ_EXTERNAL_STORAGE)
                != PackageManager.PERMISSION_GRANTED){

            //Verifica se o usuário selecionou a opções de não perguntar novamente.
            if(ActivityCompat.shouldShowRequestPermissionRationale(ActAtualizaReceita.this,
                    android.Manifest.permission.READ_EXTERNAL_STORAGE)) {
                alerta.show();
            }else{
                ActivityCompat.requestPermissions(ActAtualizaReceita.this,
    ...
    protected void onActivityResult(int codigoRequisicao, int codigoResultado, Intent imagem) {
        ...
        if(codigoRequisicao == 1 && codigoResultado == RESULT_OK){
            ...
            Picasso.with(ActAtualizaReceita.this).load(imagemSelecionada).transform(new TransformacaoCirculo()).into(ivFoto);
        }
    }
            ...
            try {
                ...
                if(resultado.length() == 0){
                    ...
                    if(Mensagem.isMensagem(json)){
                        ...
                        Toast.makeText(ActAtualizaReceita.this, msg.getMensagem(), Toast.LENGTH_SHORT).show();

                        if(metodo.trim().equals("AtualizarReceita") && msg.getCodigo() == 6){
                            Intent tela = new Intent(ActAtualizaReceita.this,ActPrincipal.class);
                            startActivity(tela);
                        }
